...
def waspas_page():
    ...
    with st.expander("Edit Criteria Weights, Types, and Lambda"):
        ...
        lambda_param = st.slider("Set Lambda (Weighting Coefficient)", min_value=0.0, max_value=1.0, value=default_lambda)
